...
[![AAAAAAAAAA.png](https://i.postimg.cc/59S6RN8j/AAAAAAAAAA.png)](https://postimg.cc/grrzwpSP)

	- บรรทัดที่ 73 เป็นส่วนของ header ตารางซึ่งจะระบุตาม Colum ดังนี้
		  คอลัมน์ A คือ ส่วนของการเปิดปิดการใช้งานค่าเวลาที่กำหนด
		  คอลัมน์ B คือ ส่วนของการกำหนดจำนวนวันที่ต้องการให้ทำงาน
		  คอลัมน์ C คือ ส่วนของการกำหนด ชั่วโมง การทำงาน
		  คอลัมน์ D คือ ส่วนของการกำหนด นาที การทำงาน
		  คอลัมน์ E คือ ส่วนของการกำหนด วินาที การทำงาน
	- บรรทัดที่ 74-83 เป็นส่วนของการกำหนดการใช้ Time ตามรูปแบบ 
		  เช่น ทำการ Config ค่าในบรรทัดที่ 27   
		        คอลัมน์ A	กำหนด on
		        คอลัมน์ B	กำหนด วัน เป็น 1 = 1 วัน
	        	คอลัมน์ C	กำหนด ชั่วโมง เป็น 5 = 5ชั่วโมง 	
	        	คอลัมน์ D	กำหนด นาที เป็น 30 = 30 นาที 	
	        	คอลัมน์ E	กำหนด วินาที เป็น 0 = 0 วินาที
...
[![aaaaaa.png](https://i.postimg.cc/c4GBQH0H/aaaaaa.png)](https://postimg.cc/9z192c45)
	...
	- บรรทัดที่ 89 เป็นส่วนของ header ตารางซึ่งจะระบุตาม Colum ดังนี้
		  คอลัมน์ A คือ กำหนด on หรือ off เพื่อเปิด/ปิด พอร์ต Digital
	  	  ...
	  	  คอลัมน์ C คือ ส่วนนี้จะเป็นการนำ name ของอุปกรณ์ที่เราอ่านมาได้จากพอร์ตของ RS485, Analog หรือ Digital มาเข้าเงื่อนไขเพื่อทำการเปรียบเทียบ
	  	  คอลัมน์ D คือ กำหนดเครื่องหมาย >, <, =, >=, <=, #เพื่อเปรียบเทียบ
	  	  คอลัมน์ E คือ กำหนดค่าตัวแปร ค่าที่อ่านมาได้จากอุปกรณ์ หรือ เวลา เพื่อนำมาเข้าเงื่อนไขเพื่อทำการเปรียบเทียบ
	  	  คอลัมน์ F คือ กำหนดพอร์ตที่จะใช้งาน D0-D15
	  	  คอลัมน์ G คือ กำหนดสถานะการทำงาน high หรือ low 
	  	  คอลัมน์ H คือ กำหนดเวลาในการส่ง output 
	- บรรทัดที่ 90-99 เป็นส่วนของการกำหนดการใช้เงื่อนไข ตามรูปแบบ 
		  เช่น ทำการ Config ค่าในบรรทัดที่ 90
		  	คอลัมน์ A	กำหนด on
			คอลัมน์ B กำหนด on
			คอลัมน์ C กำหนด Time count (การนับเวลา) 
			คอลัมน์ D กำหนด เครื่องหมาย =
			คอลัมน์ E กำหนด ดึงชื่อตัวแปร Time3 (จาก Time Config) 
			คอลัมน์ F กำหนด พอร์ต D1
			คอลัมน์ G กำหนด กำหนด สถานะพอร์ตให้เป็น high
			คอลัมน์ H กำหนด ส่งเอาต์พุต 0.5 วินาที
