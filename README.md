...
๏**ส่วนที่สอง** นั้นจะเป็นส่วนของการ Config ค่าเวลา ประกอบไปด้วย
...
[![8.png](https://i.postimg.cc/T3GWqhF5/8.png)](https://postimg.cc/sv6X3fV3)
	...
	- บรรทัดที่ 74-83 เป็นส่วนของการกำหนดการใช้ Time ตามรูปแบบ 
		  เช่น   กำหนดชื่อ Time1 ในบรรทัดที่ 27 คอลัมน์ A 
			กำหนด on ในบรรทัดที่ 27 คอลัมน์ B
			กำหนด วัน เป็น 1 = 1 วัน
			กำหนด ชั่วโมง เป็น 5 = 5ชั่วโมง ในบรรทัดที่ 27 คอลัมน์ D
			กำหนด นาที เป็น 30 = 30 นาที ในบรรทัดที่ 27 คอลัมน์ E
			กำหนด วินาที เป็น 0 = 0 วินาที ในบรรทัดที่ 27 คอลัมน์ F
	ผลที่ออกมาคือ จะทำงานเป็นจำนวน 1 วัน ทำงาน 5 ชั่วโมงกับอีก 30 นาที
